...
class UiMainWindow(object):
    ...
    def setupui(self, mainwindow):
        ...
        self.lineeditnumcont = QLineEdit()
        self.lineeditnumcont.setText('1')
        self.lineeditnumcont.editingFinished.connect(self.lineeditnumcont_editingFinished)
        self.openclosedistspacer.addWidget(QLabel('К-во контр.'))
        self.openclosedistspacer.addWidget(self.lineeditnumcont)
        ...
        self.openclosedistspacer.addWidget(QLabel('Дист. закр.'))

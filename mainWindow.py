...
# ------>
        ...
        self.l_balance_dgtx.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
        ...
        self.l_balance_usd.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
...
# ------>
        ...
        self.l_margin_order.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
        ...
        self.l_margin_contr.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
...
# ------>
        ...
        self.l_available_dgtx.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
        ...
        self.l_available_usd.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
...
# ------>
        ...
        self.l_unpnl = QLabel()
        self.l_unpnl.setStyleSheet("color:rgb(0, 0, 32); font: bold 16px;")
        self.infogridlayout.addWidget(self.l_unpnl, 3, 1, 1, 1)
        self.l_unpnl_l = QLabel('UnPnL')
        self.l_unpnl_l.setStyleSheet("color:rgb(0, 0, 32); font: bold 12px")
        self.infogridlayout.addWidget(self.l_unpnl_l, 3, 2, 1, 1)
        self.l_pnl = QLabel()
...
# ------>
        ...
        self.splitterh.setSizes([200, 200])
        ...
        self.le_numcont.setText(str(mainwindow.cur_innerstate['numconts']))
        ...
        self.le_orderdist.setText(str(mainwindow.cur_innerstate['orderdist']))
